...
namespace Application.Endpoint
{
    public class DataStore
    {
        ...
        static DataStore()
        {
            ...
            _colores.Add(new Color { ID = 1, NOMBRE_COLOR = "Rojo" });
            _colores.Add(new Color { ID = 2, NOMBRE_COLOR = "Verde" });
            _colores.Add(new Color { ID = 3, NOMBRE_COLOR = "Azul" });
        }
        ...
        public static void AgregarColor(Color nuevoColor)
        {
            ...
            nuevoColor.ID = _colores.Count + 1;
        ...
        {
            return _colores.FirstOrDefault(c => c.ID == id);
        }

        // Método para borrar un color por su ID
        public void BorrarColor(int id)
        {
            Color colorExistente = _colores.FirstOrDefault(c => c.ID == id);
